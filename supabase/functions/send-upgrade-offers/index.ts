...
function buildLeadsEmail({
  ...
  if (lang === 'es') {
    return {
      ...
      html: `<div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:24px">
        <h2 style="color:#2B5EBE;font-family:Nunito,sans-serif">🧬 Hola desde Peptide Alliance</h2>
  ...
  return {
    ...
    html: `<div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:24px">
      <h2 style="color:#2B5EBE;font-family:Nunito,sans-serif">🧬 Hello from Peptide Alliance</h2>
...
function buildBoostEmail({
  ...
  if (lang === 'es') {
    return {
      ...
      html: `<div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:24px">
        ...
        <div style="background:#EAF4E8;border-radius:12px;padding:20px;margin:20px 0">
          <p style="font-weight:600;color:#374151">El mes pasado, <strong>${categorySearchCount} personas</strong> buscaron en tu categoría en Peptide Alliance.</p>
  ...
  return {
    ...
    html: `<div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;padding:24px">
      ...
      <div style="background:#EAF4E8;border-radius:12px;padding:20px;margin:20px 0">
        <p style="font-weight:600;color:#374151">Last month, <strong>${categorySearchCount} people</strong> searched in your category on Peptide Alliance.</p>
