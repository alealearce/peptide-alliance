...
const resend = new Resend('re_iKueVP5e_C6FnvCz9jc35eSWHHVmdWdsS');
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:20px;overflow:hidden;border:1px solid #e2e8f0">
        ...
        <tr><td style="padding:40px 40px 24px">
          ...
          <p style="margin:0 0 16px;font-size:15px;color:#4a5568;line-height:1.7">
            We wanted to reach out to let you know that <strong style="color:#1a202c">[Business Name]</strong> has been added to
            ...
            <tr>
              ...
              <td>
                ...
                <p style="margin:0;font-size:14px;color:#4a5568;line-height:1.6">
                  ...
                  A presence on Peptide Alliance signals that your business is legitimate, established, and
          ...
          <table width="100%" cellpadding="0" cellspacing="0" style="background:#eff6ff;border-radius:14px;padding:20px;border-left:4px solid #3b82f6">
            <tr>
              ...
              <td>
                ...
                <p style="margin:0;font-size:14px;color:#4a5568;line-height:1.6">
                  Peptide Alliance is a <strong>traffic generation platform, not a marketplace</strong> — we do not take a cut
...
const { data, error } = await resend.emails.send({
  ...
  to: 'hi@arce.ca',
  subject: '📋 [PREVIEW] [Business Name] has been added to The Peptide Alliance',
  html,
});
...
if (error) {
  ...
  console.log('✓ Preview sent to hi@arce.ca —', data.id);
}
